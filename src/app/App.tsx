...
const PLATFORMS = [
  { id: "spotify",   name: "Spotify",     cta: "Listen Now",  href: "https://open.spotify.com/artist/0pYbVdhffwzvHfEBdeFEUC?si=KV5tdQkiTN6rRd9_46yLXA", color: "#1DB954", neon: "#00ff7f", glow: "rgba(29,185,84,0.32)",    icon: <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8"><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.419 1.56-.299.421-1.02.599-1.559.3z"/></svg> },
  { id: "apple",    name: "Apple Music", cta: "Listen Now",  href: "https://music.apple.com/us/artist/jxxmal/1896724847",                                   color: "#fc3c44", neon: "#ff2d55", glow: "rgba(252,60,68,0.32)",    icon: <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg> },
  { id: "youtube",  name: "YouTube",     cta: "Watch Now",   href: "https://www.youtube.com/@JXXMALMUSIK",                                                   color: "#FF0000", neon: "#ff3b3b", glow: "rgba(255,0,0,0.28)",     icon: <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg> },
  { id: "instagram",name: "Instagram",   cta: "Follow Now",  href: "https://www.instagram.com/jxxmalmusik/",                                                 color: "#E1306C", neon: "#ff2d78", glow: "rgba(225,48,108,0.32)", icon: <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg> },
];
        ...
        <motion.div className="fixed inset-0 z-[200] flex flex-col items-center justify-center" style={{ background: "#000" }} exit={{ opacity: 0 }} transition={{ duration: 0.7 }}>
          ...
          <div style={{ display: "flex" }}>
            {"JXXMAL".split("").map((l, i) => (
              <motion.span key={i} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9 + i * 0.08, duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
                style={{ display: "inline-block", fontFamily: "'Big Shoulders Display',sans-serif", fontWeight: 900, fontSize: "clamp(4rem,18vw,8rem)", lineHeight: 1, background: "linear-gradient(130deg,#f0eeff 20%,#a855f7 58%,#86efac 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>{l}
              </motion.span>
            ))}
          </div>
        ...
        <motion.div className="fixed inset-0 z-[150] flex flex-col items-center justify-center gap-6" style={{ background: "#07060f" }} exit={{ opacity: 0 }} transition={{ duration: 0.6 }}>
          ...
          <div className="flex items-end gap-[3px]" style={{ height: 24 }}>
            {BAR_HEIGHTS.slice(0, 7).map((h, i) => (
              <div key={i} className="rounded-full" style={{ width: 3, height: `${h}%`, background: i % 2 === 0 ? "linear-gradient(to top,#a855f7,#c084fc)" : "linear-gradient(to top,#86efac,#a855f7)", transformOrigin: "bottom", animation: `waveBar ${.55+(i%5)*.12}s ease-in-out ${i*.06}s infinite alternate` }} />
            ))}
          </div>
...
function Glass({ children, className = "", style = {} }: { children: React.ReactNode; className?: string; style?: React.CSSProperties }) {
  return (
    <div className={`rounded-2xl ${className}`} style={{ background: "rgba(255,255,255,0.04)", backdropFilter: "blur(20px)", border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 8px 32px rgba(0,0,0,0.4),inset 0 1px 0 rgba(255,255,255,0.06)", ...style }}>
      {children}
    </div>
  );
}
...
// ─── Hero ─────────────────────────────────────────────────────────────────────
function Hero({ eggCount, onEggTap }: { eggCount: number; onEggTap: () => void }) {
  return (
    <section className="flex flex-col items-center pt-16 pb-8">
      <motion.div initial={{ opacity: 0, scale: 0.82 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.65, ease: [0.22, 1, 0.36, 1] }} className="relative mb-5 cursor-pointer" onClick={onEggTap}>
        ...
        {eggCount > 0 && eggCount < 7 && (
          <div className="absolute -bottom-1 -right-1 w-4 h-4 rounded-full flex items-center justify-center text-[8px] font-bold" style={{ background: "#a855f7", color: "#fff", zIndex: 2 }}>{eggCount}</div>
        )}
      </motion.div>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.85 }} className="text-center mb-3" style={{ fontFamily: "'Big Shoulders Display',sans-serif", fontWeight: 900, fontSize: "clamp(0.9rem,4vw,1.2rem)", letterSpacing: "0.04em" }}>
...
function NowPlayingCard() {
  ...
  const pct = data.duration && data.progress ? Math.round((data.progress / data.duration) * 100) : 52;
  const fmt = (ms?: number) => { if (!ms) return "—"; const s = Math.floor(ms / 1000); return `${Math.floor(s / 60)}:${String(s % 60).padStart(2, "0")}`; };
        ...
        {loading ? (
          ...
          <>
            <div className="flex items-center gap-4">
              {/* Album art */}
              <a href={data.songUrl ?? "https://open.spotify.com/artist/0pYbVdhffwzvHfEBdeFEUC"} target="_blank" rel="noopener noreferrer" className="relative flex-shrink-0 w-16 h-16 rounded-xl overflow-hidden block" style={{ border: "1px solid rgba(168,85,247,0.3)" }}>
                {data.albumArt ? (
                  <img src={data.albumArt} alt={data.albumName ?? "Album art"} className="w-full h-full object-cover" />
                ) : (
                  <div className="w-full h-full flex items-center justify-center" style={{ background: "linear-gradient(135deg,#1a1830,#0d0c1a)" }}>
                    <svg viewBox="0 0 24 24" fill="rgba(168,85,247,0.6)" className="w-7 h-7"><path d="M12 3v10.55A4 4 0 1014 17V7h4V3h-6z"/></svg>
                  </div>
                )}
                {data.isPlaying && <div className="absolute inset-0" style={{ background: "rgba(168,85,247,0.1)", animation: "progressPulse 2s ease-in-out infinite" }} />}
              </a>

              {/* Track info */}
              <div className="flex-1 min-w-0">
                <div className="text-sm font-semibold truncate" style={{ color: "#f0eeff", fontFamily: "'Outfit',sans-serif" }}>
                  {data.isPlaying ? data.title : "Nothing playing right now"}
                </div>
                <div className="text-[11px] mb-2 truncate" style={{ color: "rgba(240,238,255,0.4)", fontFamily: "'Outfit',sans-serif" }}>
                  {data.isPlaying ? data.artist : "JXXMAL on Spotify"}
                </div>
                <div className="w-full rounded-full h-1" style={{ background: "rgba(255,255,255,0.08)" }}>
                  <div className="h-full rounded-full transition-all duration-1000" style={{ width: `${pct}%`, background: "linear-gradient(90deg,#a855f7,#86efac)" }} />
                </div>
                <div className="flex justify-between mt-1">
                  <span className="text-[10px]" style={{ color: "rgba(240,238,255,0.3)", fontFamily: "'Outfit',sans-serif" }}>{fmt(data.progress)}</span>
                  <span className="text-[10px]" style={{ color: "rgba(240,238,255,0.3)", fontFamily: "'Outfit',sans-serif" }}>{fmt(data.duration)}</span>
                </div>
              </div>

              {/* Waveform */}
              {data.isPlaying && <Waveform bars={5} height={20} />}
            </div>

            {/* Controls */}
            <div className="mt-3 flex items-center justify-center gap-6">
              {[{ icon: "◁◁", size: 13 }, { icon: data.isPlaying ? "⏸" : "▶", size: 18 }, { icon: "▷▷", size: 13 }].map((btn, i) => (
                <a key={i} href={data.songUrl ?? "https://open.spotify.com/artist/0pYbVdhffwzvHfEBdeFEUC"} target="_blank" rel="noopener noreferrer"
                  className="flex items-center justify-center rounded-full transition-transform hover:scale-110 active:scale-95"
                  style={{ width: i === 1 ? 38 : 30, height: i === 1 ? 38 : 30, background: i === 1 ? "rgba(168,85,247,0.2)" : "transparent", border: i === 1 ? "1px solid rgba(168,85,247,0.4)" : "none", color: i === 1 ? "#a855f7" : "rgba(240,238,255,0.5)", fontSize: btn.size, textDecoration: "none" }}>
                  {btn.icon}
                </a>
              ))}
            </div>
            ...
            {!data.isPlaying && (
              <div className="mt-3 text-center text-[9px] tracking-widest" style={{ color: "rgba(240,238,255,0.18)", fontFamily: "'Outfit',sans-serif" }}>OPEN SPOTIFY TO START PLAYING</div>
            )}
          </>
        )}
      </Glass>
      ...
      <Glass className="mt-3 px-4 py-3">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex gap-1.5 flex-wrap justify-end">
            {["Hip Hop","Motivational","Caribbean"].map(tag => (
              <span key={tag} className="text-[10px] px-2 py-0.5 rounded-full tracking-wide" style={{ background: "rgba(168,85,247,0.15)", border: "1px solid rgba(168,85,247,0.25)", color: "rgba(240,238,255,0.6)", fontFamily: "'Outfit',sans-serif" }}>{tag}</span>
            ))}
          </div>
        </div>
      </Glass>
    ...
    <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="w-full max-w-md mx-auto mb-6 px-4">
      ...
      {videos.length === 0 ? (
        ...
        <div className="flex gap-3 overflow-x-auto pb-2" style={{ scrollSnapType: "x mandatory" }}>
          {ordered.map((v, i) => {
            const isFeatured = i === ordered.length - 1;
            const color = isFeatured ? "#86efac" : i % 2 === 0 ? "#a855f7" : "#22d3ee";
            return (
              <a key={v.id} href={`https://www.youtube.com/watch?v=${v.id}`} target="_blank" rel="noopener noreferrer" className="flex-shrink-0 no-underline block" style={{ width: 148, scrollSnapAlign: "start" }}>
                <Glass className={`p-0 overflow-hidden h-full`} style={{ borderColor: isFeatured ? `${color}40` : undefined, boxShadow: isFeatured ? `0 0 20px ${color}20` : undefined }}>
                  {/* Cover art thumbnail */}
                  <div className="relative w-full" style={{ aspectRatio: "1" }}>
                    <img src={v.thumbnail} alt={v.title} className="w-full h-full object-cover" style={{ filter: isFeatured ? "brightness(1)" : "brightness(0.75)" }} />
                    {isFeatured && <div className="absolute inset-0" style={{ background: `linear-gradient(to bottom,transparent 50%,rgba(7,6,15,0.6))` }} />}
                    {isFeatured && (
                      <div className="absolute top-2 right-2 text-[8px] tracking-widest uppercase px-1.5 py-0.5 rounded-full" style={{ background: `${color}30`, color, border: `1px solid ${color}50`, fontFamily: "'Outfit',sans-serif" }}>Latest</div>
                    )}
                  </div>
                  <div className="px-3 py-2.5">
                    <div className="text-xs font-semibold leading-tight mb-1 line-clamp-2" style={{ color: "#f0eeff", fontFamily: "'Outfit',sans-serif" }}>{v.title}</div>
                    <div className="text-[10px]" style={{ color: "rgba(240,238,255,0.35)", fontFamily: "'Outfit',sans-serif" }}>{new Date(v.publishedAt).toLocaleDateString("en-US", { month: "short", year: "numeric" })}</div>
                  </div>
                </Glass>
              </a>
            );
          ...
          <div className="flex-shrink-0" style={{ width: 148, scrollSnapAlign: "start" }}>
            <Glass className="h-full flex flex-col items-center justify-center text-center p-4" style={{ minHeight: 200 }}>
  ...
  return (
    <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="w-full max-w-md mx-auto mb-6 px-4">
      ...
      <Glass className="relative overflow-hidden p-6 text-center" style={{ background: "rgba(168,85,247,0.05)" }}>
        ...
        {!notified ? (
          <button onClick={() => setNotified(true)} className="px-6 py-2.5 rounded-full text-sm font-medium tracking-wide transition-all duration-200 hover:scale-105 active:scale-95" style={{ background: "rgba(168,85,247,0.2)", border: "1px solid rgba(168,85,247,0.4)", color: "#c084fc", fontFamily: "'Outfit',sans-serif", boxShadow: "0 0 20px rgba(168,85,247,0.2)" }}>
            Notify Me
          </button>
        ) : (
        ...
        <div className="relative text-center">
          ...
          {status === "done" ? (
            ...
            <form onSubmit={submit} className="flex gap-2">
              ...
              <button type="submit" disabled={status === "loading"} className="px-4 py-2.5 rounded-xl text-sm font-semibold tracking-wide transition-all hover:scale-105 active:scale-95 disabled:opacity-60" style={{ background: "linear-gradient(135deg,#22d3ee,#a855f7)", color: "#fff", fontFamily: "'Outfit',sans-serif", boxShadow: "0 0 20px rgba(34,211,238,0.25)", whiteSpace: "nowrap" }}>
...
function ListenerGlobe() {
  const dots = [{ x: 57, y: 38 },{ x: 50, y: 48 },{ x: 62, y: 35 },{ x: 46, y: 42 },{ x: 47, y: 39 },{ x: 55, y: 55 },{ x: 40, y: 44 },{ x: 70, y: 45 }];
  return (
    <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="w-full max-w-md mx-auto mb-6 px-4">
      <SectionLabel>Global Listeners</SectionLabel>
      <Glass className="p-6 flex flex-col items-center">
        <div className="relative mb-4" style={{ width: 220, height: 220 }}>
          <div className="absolute inset-0 rounded-full" style={{ background: "radial-gradient(ellipse at 35% 30%,rgba(168,85,247,0.25) 0%,rgba(7,6,15,0.95) 65%)", border: "1px solid rgba(168,85,247,0.2)", boxShadow: "0 0 60px rgba(168,85,247,0.15),inset 0 0 40px rgba(7,6,15,0.8)" }} />
          <svg className="absolute inset-0 w-full h-full" viewBox="0 0 220 220" style={{ opacity: 0.3 }}>
            {[20,45,65,80].map(r => <ellipse key={r} cx="110" cy="110" rx="78" ry={r} fill="none" stroke="rgba(168,85,247,0.6)" strokeWidth="0.4"/>)}
            {[15,40,65,90].map(rx => <ellipse key={rx} cx="110" cy="110" rx={rx} ry="78" fill="none" stroke="rgba(168,85,247,0.6)" strokeWidth="0.4"/>)}
          </svg>
          <div className="absolute inset-0 rounded-full overflow-hidden">
            <div style={{ position: "absolute", inset: "-100%", background: "conic-gradient(from 0deg,transparent 85%,rgba(168,85,247,0.15) 92%,transparent 100%)", animation: "rotateBorder 6s linear infinite" }} />
          </div>
          {dots.map((dot, i) => (
            <div key={i} className="absolute" style={{ left: `${dot.x}%`, top: `${dot.y}%`, transform: "translate(-50%,-50%)" }}>
              <div className="absolute rounded-full" style={{ width: 8, height: 8, background: "#a855f7", animation: `pingDot ${2+i*.3}s ease-out ${i*.25}s infinite`, top: 0, left: 0 }} />
              <div className="w-2 h-2 rounded-full" style={{ background: "#c084fc", boxShadow: "0 0 8px #a855f7,0 0 16px rgba(168,85,247,.5)" }} />
            </div>
          ))}
          <div className="absolute rounded-full pointer-events-none" style={{ inset: -8, border: "1px solid rgba(168,85,247,0.1)", animation: "pulseGlow 3s ease-in-out infinite" }} />
        </div>
        <div className="text-center">
          <div className="text-sm font-semibold mb-1" style={{ color: "#f0eeff", fontFamily: "'Outfit',sans-serif" }}>Worldwide &amp; Growing</div>
          <div className="text-[11px]" style={{ color: "rgba(240,238,255,0.35)", fontFamily: "'Outfit',sans-serif" }}>Listeners across the Caribbean, Americas &amp; Europe</div>
        </div>
      </Glass>
    </motion.section>
  );
    ...
    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.4, duration: 0.6 }} className="fixed bottom-0 left-0 right-0 z-40 flex items-center justify-center gap-3" style={{ paddingTop: 10, paddingBottom: 14, background: "linear-gradient(to top,rgba(7,6,15,1),rgba(7,6,15,0.7))", backdropFilter: "blur(16px)", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
      ...
      <div className="flex items-end gap-px" style={{ height: 13 }}>
        {[40,80,55,100,65].map((h, i) => (
          <div key={i} className="rounded-full" style={{ width: 2, height: `${h}%`, background: "#a855f7", transformOrigin: "bottom", animation: `waveBar ${.5+i*.13}s ease-in-out ${i*.09}s infinite alternate` }} />
        ))}
      </div>
    </motion.div>
  );
...
export default function App() {
  ...
  useEffect(() => { fetchChannelVideos().then(setVideos); }, []);
      ...
      <AnimatePresence>
        {ready && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6 }} className="pb-24">
            <Hero eggCount={eggCount} onEggTap={handleEggTap} />
            <NowPlayingCard />
